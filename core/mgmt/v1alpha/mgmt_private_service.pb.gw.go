...
func RegisterMgmtPrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MgmtPrivateServiceServer) error {
	...
	mux.Handle("GET", pattern_MgmtPrivateService_ListUsersAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/ListUsersAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/users"))
		if err != nil {
	...
	mux.Handle("GET", pattern_MgmtPrivateService_GetUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/GetUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_LookUpUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/LookUpUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{permalink=users/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_ListOrganizationsAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/ListOrganizationsAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/organizations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_GetOrganizationAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/GetOrganizationAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=organizations/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_LookUpOrganizationAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/LookUpOrganizationAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{permalink=organizations/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMgmtPrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MgmtPrivateServiceClient) error {
	...
	mux.Handle("GET", pattern_MgmtPrivateService_ListUsersAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/ListUsersAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_GetUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/GetUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_LookUpUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/LookUpUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{permalink=users/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_ListOrganizationsAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/ListOrganizationsAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/organizations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_GetOrganizationAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/GetOrganizationAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=organizations/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_LookUpOrganizationAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/core.mgmt.v1alpha.MgmtPrivateService/LookUpOrganizationAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{permalink=organizations/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_MgmtPrivateService_ListOrganizationsAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1alpha", "admin", "organizations"}, ""))

	pattern_MgmtPrivateService_GetOrganizationAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 2, 5, 3}, []string{"v1alpha", "admin", "organizations", "name"}, ""))

	pattern_MgmtPrivateService_LookUpOrganizationAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 2, 5, 3, 2, 4}, []string{"v1alpha", "admin", "organizations", "permalink", "lookUp"}, ""))
)
