...
const file_core_mgmt_v1beta_metric_proto_rawDesc = "" +
	"\n" +
	"\x1dcore/mgmt/v1beta/metric.proto\x12\x10core.mgmt.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x7f\n" +
	"\fTriggerCount\x12(\n" +
	"\rtrigger_count\x18\x01 \x01(\x05B\x03\xe0A\x03R\ftriggerCount\x12:\n" +
	"\x06status\x18\x02 \x01(\x0e2\x18.core.mgmt.v1beta.StatusB\x03\xe0A\x03H\x00R\x06status\x88\x01\x01B\t\n" +
	"\a_status\"\xc7\x01\n" +
	...
	"\x17pipeline_trigger_counts\x18\x01 \x03(\v2\x1e.core.mgmt.v1beta.TriggerCountR\x15pipelineTriggerCounts\"\xc4\x01\n" +
	...
	"\x14model_trigger_counts\x18\x01 \x03(\v2\x1e.core.mgmt.v1beta.TriggerCountR\x12modelTriggerCounts\"\xef\x01\n" +
	...
	"\x1epipeline_trigger_chart_records\x18\x01 \x03(\v2,.core.mgmt.v1beta.PipelineTriggerChartRecordR\x1bpipelineTriggerChartRecords\"\xe3\x01\n" +
	...
	"\x1epipeline_trigger_table_records\x18\x01 \x03(\v2,.core.mgmt.v1beta.PipelineTriggerTableRecordR\x1bpipelineTriggerTableRecords\x12&\n" +
	...
	"\a_filter\"\xa0\x01\n" +
	")ListPipelineTriggerChartRecordsV0Response\x12s\n" +
	"\x1epipeline_trigger_chart_records\x18\x01 \x03(\v2..core.mgmt.v1beta.PipelineTriggerChartRecordV0R\x1bpipelineTriggerChartRecords\"\xe9\x03\n" +
	"\x1cPipelineTriggerChartRecordV0\x12\x1f\n" +
	"\vpipeline_id\x18\x01 \x01(\tR\n" +
	"pipelineId\x12!\n" +
	"\fpipeline_uid\x18\x02 \x01(\tR\vpipelineUid\x129\n" +
	"\ftrigger_mode\x18\x03 \x01(\x0e2\x16.core.mgmt.v1beta.ModeR\vtriggerMode\x125\n" +
	"\x06status\x18\x04 \x01(\x0e2\x18.core.mgmt.v1beta.StatusB\x03\xe0A\x03R\x06status\x12B\n" +
	...
	"\x14pipeline_release_uid\x18\t \x01(\tB\x03\xe0A\x03R\x12pipelineReleaseUid\"\xe1\x03\n" +
	...
	"pipelineId\x12!\n" +
	"\fpipeline_uid\x18\x04 \x01(\tR\vpipelineUid\x129\n" +
	"\ftrigger_mode\x18\x05 \x01(\x0e2\x16.core.mgmt.v1beta.ModeR\vtriggerMode\x127\n" +
	"\x15compute_time_duration\x18\x06 \x01(\x02B\x03\xe0A\x03R\x13computeTimeDuration\x125\n" +
	"\x06status\x18\a \x01(\x0e2\x18.core.mgmt.v1beta.StatusB\x03\xe0A\x03R\x06status\x123\n" +
	"\x13pipeline_release_id\x18\b \x01(\tB\x03\xe0A\x03R\x11pipelineReleaseId\x125\n" +
	...
	"\v_page_tokenB\t\n" +
	"\a_filter\"\xce\x01\n" +
	"\"ListPipelineTriggerRecordsResponse\x12a\n" +
	"\x18pipeline_trigger_records\x18\x01 \x03(\v2'.core.mgmt.v1beta.PipelineTriggerRecordR\x16pipelineTriggerRecords\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	...
	"\x0eSTATUS_ERRORED\x10\x02B\xc4\x01\n" +
	"\x14com.core.mgmt.v1betaB\vMetricProtoP\x01Z=github.com/instill-ai/protogen-go/core/mgmt/v1beta;mgmtv1beta\xa2\x02\x03CMX\xaa\x02\x10Core.Mgmt.V1beta\xca\x02\x10Core\\Mgmt\\V1beta\xe2\x02\x1cCore\\Mgmt\\V1beta\\GPBMetadata\xea\x02\x12Core::Mgmt::V1betab\x06proto3"

var (
	file_core_mgmt_v1beta_metric_proto_rawDescOnce sync.Once
	file_core_mgmt_v1beta_metric_proto_rawDescData []byte
)

func file_core_mgmt_v1beta_metric_proto_rawDescGZIP() []byte {
	file_core_mgmt_v1beta_metric_proto_rawDescOnce.Do(func() {
		file_core_mgmt_v1beta_metric_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_core_mgmt_v1beta_metric_proto_rawDesc), len(file_core_mgmt_v1beta_metric_proto_rawDesc)))
	})
...
func file_core_mgmt_v1beta_metric_proto_init() {
	...
	file_core_mgmt_v1beta_metric_proto_msgTypes[0].OneofWrappers = []any{}
	file_core_mgmt_v1beta_metric_proto_msgTypes[1].OneofWrappers = []any{}
	file_core_mgmt_v1beta_metric_proto_msgTypes[3].OneofWrappers = []any{}
	file_core_mgmt_v1beta_metric_proto_msgTypes[5].OneofWrappers = []any{}
	file_core_mgmt_v1beta_metric_proto_msgTypes[6].OneofWrappers = []any{}
