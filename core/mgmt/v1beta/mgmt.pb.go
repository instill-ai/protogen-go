...
func (*Organization_Stats) Descriptor() ([]byte, []int) {
	return file_core_mgmt_v1beta_mgmt_proto_rawDescGZIP(), []int{57, 0}
}
...
const file_core_mgmt_v1beta_mgmt_proto_rawDesc = "" +
	...
	"\n" +
	"Permission\x12\x1e\n" +
	"\bcan_edit\x18\x01 \x01(\bB\x03\xe0A\x03R\acanEdit\"\xcd\x03\n" +
	"\vUserProfile\x12+\n" +
	"\fdisplay_name\x18\x01 \x01(\tB\x03\xe0A\x01H\x00R\vdisplayName\x88\x01\x01\x12\x1a\n" +
	"\x03bio\x18\x02 \x01(\tB\x03\xe0A\x01H\x01R\x03bio\x88\x01\x01\x12 \n" +
	"\x06avatar\x18\x03 \x01(\tB\x03\xe0A\x01H\x02R\x06avatar\x88\x01\x01\x12+\n" +
	"\fpublic_email\x18\x04 \x01(\tB\x03\xe0A\x01H\x03R\vpublicEmail\x88\x01\x01\x12+\n" +
	"\fcompany_name\x18\x05 \x01(\tB\x03\xe0A\x01H\x04R\vcompanyName\x88\x01\x01\x12l\n" +
	"\x14social_profile_links\x18\x06 \x03(\v25.core.mgmt.v1beta.UserProfile.SocialProfileLinksEntryB\x03\xe0A\x01R\x12socialProfileLinks\x1aE\n" +
	...
	"\x03bio\x18\x02 \x01(\tB\x03\xe0A\x01H\x01R\x03bio\x88\x01\x01\x12 \n" +
	"\x06avatar\x18\x03 \x01(\tB\x03\xe0A\x01H\x02R\x06avatar\x88\x01\x01\x12+\n" +
	"\fpublic_email\x18\x04 \x01(\tB\x03\xe0A\x01H\x03R\vpublicEmail\x88\x01\x01\x12t\n" +
	"\x14social_profile_links\x18\x05 \x03(\v2=.core.mgmt.v1beta.OrganizationProfile.SocialProfileLinksEntryB\x03\xe0A\x01R\x12socialProfileLinks\x1aE\n" +
	"\x17SocialProfileLinksEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0f\n" +
	"\r_display_nameB\x06\n" +
	...
	"updateTime\x12\x19\n" +
	"\x05email\x18\a \x01(\tB\x03\xe0A\x02R\x05email\x12$\n" +
	"\vcustomer_id\x18\b \x01(\tB\x03\xe0A\x03R\n" +
	"customerId\x12\x1c\n" +
	"\x04role\x18\f \x01(\tB\x03\xe0A\x01H\x01R\x04role\x88\x01\x01\x12<\n" +
	...
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01H\x01R\tpageToken\x88\x01\x01\x124\n" +
	"\x04view\x18\x03 \x01(\x0e2\x16.core.mgmt.v1beta.ViewB\x03\xe0A\x01H\x02R\x04view\x88\x01\x01\x12 \n" +
	...
	"\x05users\x18\x01 \x03(\v2\x16.core.mgmt.v1beta.UserR\x05users\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"n\n" +
	"\x13GetUserAdminRequest\x12/\n" +
	"\x04view\x18\x02 \x01(\x0e2\x16.core.mgmt.v1beta.ViewH\x00R\x04view\x88\x01\x01\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userIdB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"B\n" +
	"\x14GetUserAdminResponse\x12*\n" +
	"\x04user\x18\x01 \x01(\v2\x16.core.mgmt.v1beta.UserR\x04user\"s\n" +
	"\x16LookUpUserAdminRequest\x12/\n" +
	"\x04view\x18\x02 \x01(\x0e2\x16.core.mgmt.v1beta.ViewH\x00R\x04view\x88\x01\x01\x12\x19\n" +
	"\buser_uid\x18\x03 \x01(\tR\auserUidB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"E\n" +
	"\x17LookUpUserAdminResponse\x12*\n" +
	"\x04user\x18\x01 \x01(\v2\x16.core.mgmt.v1beta.UserR\x04user\"\xe4\x01\n" +
	...
	"\x04view\x18\x03 \x01(\x0e2\x16.core.mgmt.v1beta.ViewH\x02R\x04view\x88\x01\x01\x12\x1b\n" +
	...
	"\x05_viewB\t\n" +
	"\a_filter\"\xad\x01\n" +
	"\x1eListOrganizationsAdminResponse\x12D\n" +
	"\rorganizations\x18\x01 \x03(\v2\x1e.core.mgmt.v1beta.OrganizationR\rorganizations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\x86\x01\n" +
	"\x1bGetOrganizationAdminRequest\x12/\n" +
	"\x04view\x18\x02 \x01(\x0e2\x16.core.mgmt.v1beta.ViewH\x00R\x04view\x88\x01\x01\x12'\n" +
	"\x0forganization_id\x18\x03 \x01(\tR\x0eorganizationIdB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"b\n" +
	"\x1cGetOrganizationAdminResponse\x12B\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationR\forganization\"\x8b\x01\n" +
	"\x1eLookUpOrganizationAdminRequest\x12/\n" +
	"\x04view\x18\x02 \x01(\x0e2\x16.core.mgmt.v1beta.ViewH\x00R\x04view\x88\x01\x01\x12)\n" +
	"\x10organization_uid\x18\x03 \x01(\tR\x0forganizationUidB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"e\n" +
	"\x1fLookUpOrganizationAdminResponse\x12B\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationR\forganization\"\xeb\x01\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x16.core.mgmt.v1beta.UserB\x03\xe0A\x03R\x05users\x12+\n" +
	...
	"\auser_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x06userIdB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"B\n" +
	"\x0fGetUserResponse\x12/\n" +
	"\x04user\x18\x01 \x01(\v2\x16.core.mgmt.v1beta.UserB\x03\xe0A\x03R\x04user\"\x1d\n" +
	"\x1bGetAuthenticatedUserRequest\"\\\n" +
	"\x1cGetAuthenticatedUserResponse\x12<\n" +
	"\x04user\x18\x01 \x01(\v2#.core.mgmt.v1beta.AuthenticatedUserB\x03\xe0A\x03R\x04user\"\x9f\x01\n" +
	"\x1dPatchAuthenticatedUserRequest\x12<\n" +
	"\x04user\x18\x01 \x01(\v2#.core.mgmt.v1beta.AuthenticatedUserB\x03\xe0A\x02R\x04user\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"^\n" +
	"\x1ePatchAuthenticatedUserResponse\x12<\n" +
	"\x04user\x18\x01 \x01(\v2#.core.mgmt.v1beta.AuthenticatedUserB\x03\xe0A\x03R\x04user\",\n" +
	"\x15CheckNamespaceRequest\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x02R\x02id\"\xea\x01\n" +
	"\x16CheckNamespaceResponse\x12F\n" +
	"\x04type\x18\x01 \x01(\x0e22.core.mgmt.v1beta.CheckNamespaceResponse.NamespaceR\x04type\"\x87\x01\n" +
	"\tNamespace\x12\x19\n" +
	...
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x02R\x02id\"\x83\x03\n" +
	"\x1bCheckNamespaceAdminResponse\x12K\n" +
	"\x04type\x18\x01 \x01(\x0e27.core.mgmt.v1beta.CheckNamespaceAdminResponse.NamespaceR\x04type\x12\x10\n" +
	"\x03uid\x18\x02 \x01(\tR\x03uid\x12,\n" +
	"\x04user\x18\x03 \x01(\v2\x16.core.mgmt.v1beta.UserH\x00R\x04user\x12D\n" +
	"\forganization\x18\x04 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationH\x00R\forganization\"\x87\x01\n" +
	"\tNamespace\x12\x19\n" +
	"\x15NAMESPACE_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13NAMESPACE_AVAILABLE\x10\x01\x12\x12\n" +
	"\x0eNAMESPACE_USER\x10\x02\x12\x1a\n" +
	...
	"\x03uid\x18\x01 \x01(\tB\x03\xe0A\x02R\x03uid\"\x8b\x03\n" +
	" CheckNamespaceByUIDAdminResponse\x12P\n" +
	"\x04type\x18\x01 \x01(\x0e2<.core.mgmt.v1beta.CheckNamespaceByUIDAdminResponse.NamespaceR\x04type\x12\x0e\n" +
	...
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12&\n" +
	"\faccess_token\x18\a \x01(\tB\x03\xe0A\x03R\vaccessToken\x12;\n" +
	"\x05state\x18\b \x01(\x0e2 .core.mgmt.v1beta.ApiToken.StateB\x03\xe0A\x03R\x05state\x12\"\n" +
	"\n" +
	...
	"\n" +
	"expiration\"F\n" +
	"\x12CreateTokenRequest\x120\n" +
	"\x05token\x18\x01 \x01(\v2\x1a.core.mgmt.v1beta.ApiTokenR\x05token\"L\n" +
	"\x13CreateTokenResponse\x125\n" +
	"\x05token\x18\x01 \x01(\v2\x1a.core.mgmt.v1beta.ApiTokenB\x03\xe0A\x03R\x05token\"\x80\x01\n" +
	...
	"\x06tokens\x18\x01 \x03(\v2\x1a.core.mgmt.v1beta.ApiTokenR\x06tokens\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"7\n" +
	"\x0fGetTokenRequest\x12\x1e\n" +
	"\btoken_id\x18\x02 \x01(\tB\x03\xe0A\x02R\atokenIdJ\x04\b\x01\x10\x02\"I\n" +
	"\x10GetTokenResponse\x125\n" +
	"\x05token\x18\x01 \x01(\v2\x1a.core.mgmt.v1beta.ApiTokenB\x03\xe0A\x03R\x05token\":\n" +
	"\x12DeleteTokenRequest\x12\x1e\n" +
	"\btoken_id\x18\x02 \x01(\tB\x03\xe0A\x02R\atokenIdJ\x04\b\x01\x10\x02\"\x15\n" +
	...
	"\bpassword\x18\x02 \x01(\tB\x03\xe0A\x02R\bpassword\"\xec\x01\n" +
	"\x17AuthTokenIssuerResponse\x12`\n" +
	"\faccess_token\x18\x01 \x01(\v2=.core.mgmt.v1beta.AuthTokenIssuerResponse.UnsignedAccessTokenR\vaccessToken\x1ao\n" +
	...
	"\x1aAuthChangePasswordResponse\"\xa2\x04\n" +
	...
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x121\n" +
	"\x05owner\x18\v \x01(\v2\x16.core.mgmt.v1beta.UserB\x03\xe0A\x03R\x05owner\x12D\n" +
	"\aprofile\x18\f \x01(\v2%.core.mgmt.v1beta.OrganizationProfileB\x03\xe0A\x02R\aprofile\x12A\n" +
	"\n" +
	"permission\x18\r \x01(\v2\x1c.core.mgmt.v1beta.PermissionB\x03\xe0A\x03R\n" +
	"permission\x12?\n" +
	"\x05stats\x18\x0e \x01(\v2$.core.mgmt.v1beta.Organization.StatsB\x03\xe0A\x03R\x05stats\x1a&\n" +
	"\x05Stats\x12\x1d\n" +
	"\n" +
	"user_count\x18\x01 \x01(\x05R\tuserCount:$\xeaA!\x12\x1forganizations/{organization.id}\"\xf3\x01\n" +
	...
	"\rorganizations\x18\x01 \x03(\v2\x1e.core.mgmt.v1beta.OrganizationB\x03\xe0A\x03R\rorganizations\x12+\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\x03\xe0A\x03R\rnextPageToken\x12\"\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05B\x03\xe0A\x03R\ttotalSize\"_\n" +
	"\x19CreateOrganizationRequest\x12B\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationR\forganization\"e\n" +
	"\x1aCreateOrganizationResponse\x12G\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationB\x03\xe0A\x03R\forganization\"\x8b\x01\n" +
	"\x16GetOrganizationRequest\x124\n" +
	"\x04view\x18\x02 \x01(\x0e2\x16.core.mgmt.v1beta.ViewB\x03\xe0A\x01H\x00R\x04view\x88\x01\x01\x12,\n" +
	"\x0forganization_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0eorganizationIdB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"b\n" +
	"\x17GetOrganizationResponse\x12G\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationB\x03\xe0A\x03R\forganization\"\xcf\x01\n" +
	"\x19UpdateOrganizationRequest\x12B\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationR\forganization\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12,\n" +
	"\x0forganization_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0eorganizationId\"e\n" +
	"\x1aUpdateOrganizationResponse\x12G\n" +
	"\forganization\x18\x01 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationB\x03\xe0A\x03R\forganization\"O\n" +
	"\x19DeleteOrganizationRequest\x12,\n" +
	"\x0forganization_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x0eorganizationIdJ\x04\b\x01\x10\x02\"\x1c\n" +
	"\x1aDeleteOrganizationResponse\"\xa7\x02\n" +
	...
	"\x05state\x18\x04 \x01(\x0e2!.core.mgmt.v1beta.MembershipStateB\x03\xe0A\x03R\x05state\x12/\n" +
	"\x04user\x18\x05 \x01(\v2\x16.core.mgmt.v1beta.UserB\x03\xe0A\x03R\x04user\x12G\n" +
	"\forganization\x18\x06 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationB\x03\xe0A\x03R\forganization\"\x97\x02\n" +
	"\x0eUserMembership\x124\n" +
	"\x04name\x18\x01 \x01(\tB \x92A\x1a\xca>\x17\xfa\x02\x14user_membership_name\xe0A\x03R\x04name\x12\x17\n" +
	"\x04role\x18\x03 \x01(\tB\x03\xe0A\x03R\x04role\x12<\n" +
	"\x05state\x18\x04 \x01(\x0e2!.core.mgmt.v1beta.MembershipStateB\x03\xe0A\x02R\x05state\x12/\n" +
	"\x04user\x18\x05 \x01(\v2\x16.core.mgmt.v1beta.UserB\x03\xe0A\x03R\x04user\x12G\n" +
	"\forganization\x18\x06 \x01(\v2\x1e.core.mgmt.v1beta.OrganizationB\x03\xe0A\x03R\forganization\"@\n" +
	"\x1aListUserMembershipsRequest\x12\x1c\n" +
	"\auser_id\x18\x06 \x01(\tB\x03\xe0A\x02R\x06userIdJ\x04\b\x05\x10\x06\"f\n" +
	"\x1bListUserMembershipsResponse\x12G\n" +
	"\vmemberships\x18\x01 \x03(\v2 .core.mgmt.v1beta.UserMembershipB\x03\xe0A\x03R\vmemberships\"\xab\x01\n" +
	...
	"\n" +
	"membership\x18\x01 \x01(\v2 .core.mgmt.v1beta.UserMembershipB\x03\xe0A\x03R\n" +
	"membership\"\xf2\x01\n" +
	"\x1bUpdateUserMembershipRequest\x12E\n" +
	"\n" +
	"membership\x18\x01 \x01(\v2 .core.mgmt.v1beta.UserMembershipB\x03\xe0A\x02R\n" +
	"membership\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12\x1c\n" +
	"\auser_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x06userId\x12,\n" +
	"\x0forganization_id\x18\x04 \x01(\tB\x03\xe0A\x02R\x0eorganizationId\"e\n" +
	"\x1cUpdateUserMembershipResponse\x12E\n" +
	"\n" +
	"membership\x18\x01 \x01(\v2 .core.mgmt.v1beta.UserMembershipB\x03\xe0A\x03R\n" +
	"membership\"o\n" +
	"\x1bDeleteUserMembershipRequest\x12\x1c\n" +
	"\auser_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x06userId\x12,\n" +
	"\x0forganization_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0eorganizationIdJ\x04\b\x01\x10\x02\"\x1e\n" +
	"\x1cDeleteUserMembershipResponse\"X\n" +
	"\"ListOrganizationMembershipsRequest\x12,\n" +
	"\x0forganization_id\x18\x06 \x01(\tB\x03\xe0A\x02R\x0eorganizationIdJ\x04\b\x05\x10\x06\"v\n" +
	"#ListOrganizationMembershipsResponse\x12O\n" +
	"\vmemberships\x18\x01 \x03(\v2(.core.mgmt.v1beta.OrganizationMembershipB\x03\xe0A\x03R\vmemberships\"\xb3\x01\n" +
	" GetOrganizationMembershipRequest\x124\n" +
	"\x04view\x18\x02 \x01(\x0e2\x16.core.mgmt.v1beta.ViewB\x03\xe0A\x01H\x00R\x04view\x88\x01\x01\x12,\n" +
	"\x0forganization_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0eorganizationId\x12\x1c\n" +
	"\auser_id\x18\x04 \x01(\tB\x03\xe0A\x02R\x06userIdB\a\n" +
	"\x05_viewJ\x04\b\x01\x10\x02\"r\n" +
	"!GetOrganizationMembershipResponse\x12M\n" +
	"\n" +
	"membership\x18\x01 \x01(\v2(.core.mgmt.v1beta.OrganizationMembershipB\x03\xe0A\x03R\n" +
	"membership\"\x82\x02\n" +
	"#UpdateOrganizationMembershipRequest\x12M\n" +
	"\n" +
	"membership\x18\x01 \x01(\v2(.core.mgmt.v1beta.OrganizationMembershipB\x03\xe0A\x02R\n" +
	"membership\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12,\n" +
	"\x0forganization_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0eorganizationId\x12\x1c\n" +
	"\auser_id\x18\x04 \x01(\tB\x03\xe0A\x02R\x06userId\"u\n" +
	...
	"$DeleteOrganizationMembershipResponse\"m\n" +
	...
	"\x1bONBOARDING_STATUS_COMPLETED\x10\x02B\xc2\x01\n" +
	"\x14com.core.mgmt.v1betaB\tMgmtProtoP\x01Z=github.com/instill-ai/protogen-go/core/mgmt/v1beta;mgmtv1beta\xa2\x02\x03CMX\xaa\x02\x10Core.Mgmt.V1beta\xca\x02\x10Core\\Mgmt\\V1beta\xe2\x02\x1cCore\\Mgmt\\V1beta\\GPBMetadata\xea\x02\x12Core::Mgmt::V1betab\x06proto3"

var (
	file_core_mgmt_v1beta_mgmt_proto_rawDescOnce sync.Once
	file_core_mgmt_v1beta_mgmt_proto_rawDescData []byte
)

func file_core_mgmt_v1beta_mgmt_proto_rawDescGZIP() []byte {
	file_core_mgmt_v1beta_mgmt_proto_rawDescOnce.Do(func() {
		file_core_mgmt_v1beta_mgmt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_core_mgmt_v1beta_mgmt_proto_rawDesc), len(file_core_mgmt_v1beta_mgmt_proto_rawDesc)))
	})
...
var file_core_mgmt_v1beta_mgmt_proto_msgTypes = make([]protoimpl.MessageInfo, 92)
var file_core_mgmt_v1beta_mgmt_proto_goTypes = []any{
	...
	(*Permission)(nil),                              // 12: core.mgmt.v1beta.Permission
	...
	(*CheckNamespaceAdminRequest)(nil),              // 40: core.mgmt.v1beta.CheckNamespaceAdminRequest
	(*CheckNamespaceAdminResponse)(nil),             // 41: core.mgmt.v1beta.CheckNamespaceAdminResponse
	(*CheckNamespaceByUIDAdminRequest)(nil),         // 42: core.mgmt.v1beta.CheckNamespaceByUIDAdminRequest
	(*CheckNamespaceByUIDAdminResponse)(nil),        // 43: core.mgmt.v1beta.CheckNamespaceByUIDAdminResponse
	...
	(*InviteOrganizationMembersRequest)(nil),        // 94: core.mgmt.v1beta.InviteOrganizationMembersRequest
	(*InviteOrganizationMembersResponse)(nil),       // 95: core.mgmt.v1beta.InviteOrganizationMembersResponse
	nil, // 96: core.mgmt.v1beta.UserProfile.SocialProfileLinksEntry
	nil, // 97: core.mgmt.v1beta.OrganizationProfile.SocialProfileLinksEntry
	(*AuthTokenIssuerResponse_UnsignedAccessToken)(nil), // 98: core.mgmt.v1beta.AuthTokenIssuerResponse.UnsignedAccessToken
	(*Organization_Stats)(nil),                          // 99: core.mgmt.v1beta.Organization.Stats
	(*v1beta.HealthCheckRequest)(nil),                   // 100: common.healthcheck.v1beta.HealthCheckRequest
	(*v1beta.HealthCheckResponse)(nil),                  // 101: common.healthcheck.v1beta.HealthCheckResponse
	(*timestamppb.Timestamp)(nil),                       // 102: google.protobuf.Timestamp
	(*fieldmaskpb.FieldMask)(nil),                       // 103: google.protobuf.FieldMask
}
var file_core_mgmt_v1beta_mgmt_proto_depIdxs = []int32{
	100, // 0: core.mgmt.v1beta.LivenessRequest.health_check_request:type_name -> common.healthcheck.v1beta.HealthCheckRequest
	101, // 1: core.mgmt.v1beta.LivenessResponse.health_check_response:type_name -> common.healthcheck.v1beta.HealthCheckResponse
	100, // 2: core.mgmt.v1beta.ReadinessRequest.health_check_request:type_name -> common.healthcheck.v1beta.HealthCheckRequest
	101, // 3: core.mgmt.v1beta.ReadinessResponse.health_check_response:type_name -> common.healthcheck.v1beta.HealthCheckResponse
	96,  // 4: core.mgmt.v1beta.UserProfile.social_profile_links:type_name -> core.mgmt.v1beta.UserProfile.SocialProfileLinksEntry
	97,  // 5: core.mgmt.v1beta.OrganizationProfile.social_profile_links:type_name -> core.mgmt.v1beta.OrganizationProfile.SocialProfileLinksEntry
	102, // 6: core.mgmt.v1beta.AuthenticatedUser.create_time:type_name -> google.protobuf.Timestamp
	102, // 7: core.mgmt.v1beta.AuthenticatedUser.update_time:type_name -> google.protobuf.Timestamp
	...
	102, // 12: core.mgmt.v1beta.User.create_time:type_name -> google.protobuf.Timestamp
	102, // 13: core.mgmt.v1beta.User.update_time:type_name -> google.protobuf.Timestamp
	...
	103, // 33: core.mgmt.v1beta.PatchAuthenticatedUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	17,  // 37: core.mgmt.v1beta.CheckNamespaceAdminResponse.user:type_name -> core.mgmt.v1beta.User
	65,  // 38: core.mgmt.v1beta.CheckNamespaceAdminResponse.organization:type_name -> core.mgmt.v1beta.Organization
	...
	17,  // 40: core.mgmt.v1beta.CheckNamespaceByUIDAdminResponse.user:type_name -> core.mgmt.v1beta.User
	65,  // 41: core.mgmt.v1beta.CheckNamespaceByUIDAdminResponse.organization:type_name -> core.mgmt.v1beta.Organization
	102, // 42: core.mgmt.v1beta.ApiToken.last_use_time:type_name -> google.protobuf.Timestamp
	102, // 43: core.mgmt.v1beta.ApiToken.create_time:type_name -> google.protobuf.Timestamp
	102, // 44: core.mgmt.v1beta.ApiToken.update_time:type_name -> google.protobuf.Timestamp
	7,   // 45: core.mgmt.v1beta.ApiToken.state:type_name -> core.mgmt.v1beta.ApiToken.State
	102, // 46: core.mgmt.v1beta.ApiToken.expire_time:type_name -> google.protobuf.Timestamp
	44,  // 47: core.mgmt.v1beta.CreateTokenRequest.token:type_name -> core.mgmt.v1beta.ApiToken
	44,  // 48: core.mgmt.v1beta.CreateTokenResponse.token:type_name -> core.mgmt.v1beta.ApiToken
	44,  // 49: core.mgmt.v1beta.ListTokensResponse.tokens:type_name -> core.mgmt.v1beta.ApiToken
	44,  // 50: core.mgmt.v1beta.GetTokenResponse.token:type_name -> core.mgmt.v1beta.ApiToken
	98,  // 51: core.mgmt.v1beta.AuthTokenIssuerResponse.access_token:type_name -> core.mgmt.v1beta.AuthTokenIssuerResponse.UnsignedAccessToken
	102, // 52: core.mgmt.v1beta.Organization.create_time:type_name -> google.protobuf.Timestamp
	102, // 53: core.mgmt.v1beta.Organization.update_time:type_name -> google.protobuf.Timestamp
	17,  // 54: core.mgmt.v1beta.Organization.owner:type_name -> core.mgmt.v1beta.User
	14,  // 55: core.mgmt.v1beta.Organization.profile:type_name -> core.mgmt.v1beta.OrganizationProfile
	12,  // 56: core.mgmt.v1beta.Organization.permission:type_name -> core.mgmt.v1beta.Permission
	99,  // 57: core.mgmt.v1beta.Organization.stats:type_name -> core.mgmt.v1beta.Organization.Stats
	0,   // 58: core.mgmt.v1beta.ListOrganizationsRequest.view:type_name -> core.mgmt.v1beta.View
	65,  // 59: core.mgmt.v1beta.ListOrganizationsResponse.organizations:type_name -> core.mgmt.v1beta.Organization
	65,  // 60: core.mgmt.v1beta.CreateOrganizationRequest.organization:type_name -> core.mgmt.v1beta.Organization
	65,  // 61: core.mgmt.v1beta.CreateOrganizationResponse.organization:type_name -> core.mgmt.v1beta.Organization
	0,   // 62: core.mgmt.v1beta.GetOrganizationRequest.view:type_name -> core.mgmt.v1beta.View
	65,  // 63: core.mgmt.v1beta.GetOrganizationResponse.organization:type_name -> core.mgmt.v1beta.Organization
	65,  // 64: core.mgmt.v1beta.UpdateOrganizationRequest.organization:type_name -> core.mgmt.v1beta.Organization
	103, // 65: core.mgmt.v1beta.UpdateOrganizationRequest.update_mask:type_name -> google.protobuf.FieldMask
	65,  // 66: core.mgmt.v1beta.UpdateOrganizationResponse.organization:type_name -> core.mgmt.v1beta.Organization
	2,   // 67: core.mgmt.v1beta.OrganizationMembership.state:type_name -> core.mgmt.v1beta.MembershipState
	17,  // 68: core.mgmt.v1beta.OrganizationMembership.user:type_name -> core.mgmt.v1beta.User
	65,  // 69: core.mgmt.v1beta.OrganizationMembership.organization:type_name -> core.mgmt.v1beta.Organization
	2,   // 70: core.mgmt.v1beta.UserMembership.state:type_name -> core.mgmt.v1beta.MembershipState
	17,  // 71: core.mgmt.v1beta.UserMembership.user:type_name -> core.mgmt.v1beta.User
	65,  // 72: core.mgmt.v1beta.UserMembership.organization:type_name -> core.mgmt.v1beta.Organization
	77,  // 73: core.mgmt.v1beta.ListUserMembershipsResponse.memberships:type_name -> core.mgmt.v1beta.UserMembership
	0,   // 74: core.mgmt.v1beta.GetUserMembershipRequest.view:type_name -> core.mgmt.v1beta.View
	77,  // 75: core.mgmt.v1beta.GetUserMembershipResponse.membership:type_name -> core.mgmt.v1beta.UserMembership
	77,  // 76: core.mgmt.v1beta.UpdateUserMembershipRequest.membership:type_name -> core.mgmt.v1beta.UserMembership
	103, // 77: core.mgmt.v1beta.UpdateUserMembershipRequest.update_mask:type_name -> google.protobuf.FieldMask
	77,  // 78: core.mgmt.v1beta.UpdateUserMembershipResponse.membership:type_name -> core.mgmt.v1beta.UserMembership
	76,  // 79: core.mgmt.v1beta.ListOrganizationMembershipsResponse.memberships:type_name -> core.mgmt.v1beta.OrganizationMembership
	0,   // 80: core.mgmt.v1beta.GetOrganizationMembershipRequest.view:type_name -> core.mgmt.v1beta.View
	76,  // 81: core.mgmt.v1beta.GetOrganizationMembershipResponse.membership:type_name -> core.mgmt.v1beta.OrganizationMembership
	76,  // 82: core.mgmt.v1beta.UpdateOrganizationMembershipRequest.membership:type_name -> core.mgmt.v1beta.OrganizationMembership
	103, // 83: core.mgmt.v1beta.UpdateOrganizationMembershipRequest.update_mask:type_name -> google.protobuf.FieldMask
	76,  // 84: core.mgmt.v1beta.UpdateOrganizationMembershipResponse.membership:type_name -> core.mgmt.v1beta.OrganizationMembership
...
func file_core_mgmt_v1beta_mgmt_proto_init() {
	...
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[0].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[2].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[5].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[6].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[7].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[8].OneofWrappers = []any{
		(*Owner_User)(nil),
		(*Owner_Organization)(nil),
	}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[9].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[10].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[12].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[14].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[16].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[18].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[20].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[22].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[24].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[33].OneofWrappers = []any{
		(*CheckNamespaceAdminResponse_User)(nil),
		(*CheckNamespaceAdminResponse_Organization)(nil),
	}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[35].OneofWrappers = []any{
		(*CheckNamespaceByUIDAdminResponse_User)(nil),
		(*CheckNamespaceByUIDAdminResponse_Organization)(nil),
	}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[36].OneofWrappers = []any{
		(*ApiToken_Ttl)(nil),
		(*ApiToken_ExpireTime)(nil),
	}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[39].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[58].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[62].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[72].OneofWrappers = []any{}
	file_core_mgmt_v1beta_mgmt_proto_msgTypes[80].OneofWrappers = []any{}
	type x struct{}
