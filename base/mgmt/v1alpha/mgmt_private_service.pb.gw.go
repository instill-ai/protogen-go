...
func RegisterMgmtPrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MgmtPrivateServiceServer) error {
	...
	mux.Handle("GET", pattern_MgmtPrivateService_ListUsersAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/ListUsersAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/users"))
		if err != nil {
	...
	mux.Handle("POST", pattern_MgmtPrivateService_CreateUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/CreateUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_GetUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/GetUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_MgmtPrivateService_UpdateUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{user.name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_MgmtPrivateService_DeleteUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/DeleteUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_LookUpUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/LookUpUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{permalink=users/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMgmtPrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MgmtPrivateServiceClient) error {
	...
	mux.Handle("GET", pattern_MgmtPrivateService_ListUsersAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/ListUsersAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MgmtPrivateService_CreateUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/CreateUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_GetUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/GetUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_MgmtPrivateService_UpdateUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{user.name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_MgmtPrivateService_DeleteUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/DeleteUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=users/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MgmtPrivateService_LookUpUserAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/base.mgmt.v1alpha.MgmtPrivateService/LookUpUserAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{permalink=users/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
