...
func RegisterModelPrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ModelPrivateServiceServer) error {
	...
	mux.Handle("GET", pattern_ModelPrivateService_CheckModel_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.model.v1alpha.ModelPrivateService/CheckModel", runtime.WithHTTPPathPattern("/v1alpha/admin/{model_permalink=models/*}/check"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterModelPrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ModelPrivateServiceClient) error {
	...
	mux.Handle("GET", pattern_ModelPrivateService_CheckModel_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.model.v1alpha.ModelPrivateService/CheckModel", runtime.WithHTTPPathPattern("/v1alpha/admin/{model_permalink=models/*}/check"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
