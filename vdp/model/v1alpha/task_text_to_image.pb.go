...
type TextToImageInput struct {
	...
	// The guidance scale
	CfgScale *int64 `protobuf:"varint,3,opt,name=cfg_scale,json=cfgScale,proto3,oneof" json:"cfg_scale,omitempty"`
	// The seed
...
func (x *TextToImageInput) GetCfgScale() int64 {
...
var file_vdp_model_v1alpha_task_text_to_image_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x48, 0x01, 0x52, 0x08, 0x63, 0x66,
