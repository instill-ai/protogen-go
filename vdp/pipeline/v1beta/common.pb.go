...
var file_vdp_pipeline_v1beta_common_proto_rawDesc = []byte{
	...
	0x4e, 0x41, 0x56, 0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x02, 0x2a, 0x40, 0x0a, 0x04,
	...
	0x4c, 0x45, 0x5f, 0x56, 0x49, 0x45, 0x57, 0x45, 0x52, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d, 0x52,
	0x4f, 0x4c, 0x45, 0x5f, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x4f, 0x52, 0x10, 0x02, 0x42, 0xda,
...
var file_vdp_pipeline_v1beta_common_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_vdp_pipeline_v1beta_common_proto_goTypes = []interface{}{
	...
	(*Sharing_User)(nil),        // 6: vdp.pipeline.v1beta.Sharing.User
	(*Sharing_ShareCode)(nil),   // 7: vdp.pipeline.v1beta.Sharing.ShareCode
	nil,                         // 8: vdp.pipeline.v1beta.Sharing.UsersEntry
}
var file_vdp_pipeline_v1beta_common_proto_depIdxs = []int32{
	8, // 0: vdp.pipeline.v1beta.Sharing.users:type_name -> vdp.pipeline.v1beta.Sharing.UsersEntry
	7, // 1: vdp.pipeline.v1beta.Sharing.share_code:type_name -> vdp.pipeline.v1beta.Sharing.ShareCode
	...
	6, // 5: vdp.pipeline.v1beta.Sharing.UsersEntry.value:type_name -> vdp.pipeline.v1beta.Sharing.User
