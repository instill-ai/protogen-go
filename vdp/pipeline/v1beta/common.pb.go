...
var file_vdp_pipeline_v1beta_common_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x48, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73,
	...
	0x22, 0x2b, 0x0a, 0x10, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xac, 0x01,
	0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x0c, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c,
	0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x76, 0x64, 0x70, 0x2e,
	...
	0x65, 0x2e, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x0c, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x79, 0x22, 0x46, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x10,
	0x4e, 0x41, 0x4d, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44,
	0x10, 0x00, 0x12, 0x12, 0x0a, 0x0e, 0x4e, 0x41, 0x4d, 0x45, 0x5f, 0x41, 0x56, 0x41, 0x49, 0x4c,
	0x41, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10, 0x4e, 0x41, 0x4d, 0x45, 0x5f, 0x55,
	0x4e, 0x41, 0x56, 0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x02, 0x22, 0x6a, 0x0a, 0x0d,
	0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x17, 0x0a,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x40, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65,
	...
	0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x4f, 0x52, 0x10, 0x02, 0x42, 0xda, 0x01, 0x0a, 0x17, 0x63,
	0x6f, 0x6d, 0x2e, 0x76, 0x64, 0x70, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e,
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x42, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x50, 0x72,
...
var file_vdp_pipeline_v1beta_common_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_vdp_pipeline_v1beta_common_proto_goTypes = []interface{}{
	...
	(CheckNameResponse_Name)(0), // 1: vdp.pipeline.v1beta.CheckNameResponse.Name
	(*Sharing)(nil),             // 2: vdp.pipeline.v1beta.Sharing
	(*Permission)(nil),          // 3: vdp.pipeline.v1beta.Permission
	(*CheckNameRequest)(nil),    // 4: vdp.pipeline.v1beta.CheckNameRequest
	(*CheckNameResponse)(nil),   // 5: vdp.pipeline.v1beta.CheckNameResponse
	(*ComponentTask)(nil),       // 6: vdp.pipeline.v1beta.ComponentTask
	(*Sharing_User)(nil),        // 7: vdp.pipeline.v1beta.Sharing.User
	(*Sharing_ShareCode)(nil),   // 8: vdp.pipeline.v1beta.Sharing.ShareCode
	nil,                         // 9: vdp.pipeline.v1beta.Sharing.UsersEntry
}
var file_vdp_pipeline_v1beta_common_proto_depIdxs = []int32{
	9, // 0: vdp.pipeline.v1beta.Sharing.users:type_name -> vdp.pipeline.v1beta.Sharing.UsersEntry
	8, // 1: vdp.pipeline.v1beta.Sharing.share_code:type_name -> vdp.pipeline.v1beta.Sharing.ShareCode
	1, // 2: vdp.pipeline.v1beta.CheckNameResponse.availability:type_name -> vdp.pipeline.v1beta.CheckNameResponse.Name
	...
	7, // 5: vdp.pipeline.v1beta.Sharing.UsersEntry.value:type_name -> vdp.pipeline.v1beta.Sharing.User
