...
func RegisterPipelinePrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelinePrivateServiceServer) error {
	...
	mux.Handle("POST", pattern_PipelinePrivateService_LookUpConnectionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin", runtime.WithHTTPPathPattern("/vdp.pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterPipelinePrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelinePrivateServiceClient) error {
	...
	mux.Handle("POST", pattern_PipelinePrivateService_LookUpConnectionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin", runtime.WithHTTPPathPattern("/vdp.pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_PipelinePrivateService_LookUpConnectionAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"vdp.pipeline.v1beta.PipelinePrivateService", "LookUpConnectionAdmin"}, ""))
)
