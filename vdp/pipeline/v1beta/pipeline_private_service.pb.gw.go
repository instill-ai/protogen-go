...
var (
	filter_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0 = &utilities.DoubleArray{Encoding: map[string]int{"permalink": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)

func request_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0(ctx context.Context, marshaler runtime.Marshaler, client PipelinePrivateServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0(ctx context.Context, marshaler runtime.Marshaler, server PipelinePrivateServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LookUpConnectorDefinitionAdminRequest
	var metadata runtime.ServerMetadata
...
func RegisterPipelinePrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelinePrivateServiceServer) error {
	...
	mux.Handle("GET", pattern_PipelinePrivateService_LookUpOperatorDefinitionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePrivateService/LookUpOperatorDefinitionAdmin", runtime.WithHTTPPathPattern("/v1beta/admin/{permalink=operator-definitions/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePrivateService/LookUpConnectorDefinitionAdmin", runtime.WithHTTPPathPattern("/v1beta/admin/{permalink=connector-definitions/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPipelinePrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelinePrivateServiceClient) error {
	...
	mux.Handle("GET", pattern_PipelinePrivateService_LookUpOperatorDefinitionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePrivateService/LookUpOperatorDefinitionAdmin", runtime.WithHTTPPathPattern("/v1beta/admin/{permalink=operator-definitions/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePrivateService/LookUpConnectorDefinitionAdmin", runtime.WithHTTPPathPattern("/v1beta/admin/{permalink=connector-definitions/*}/lookUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_PipelinePrivateService_LookUpOperatorDefinitionAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 2, 5, 3, 2, 4}, []string{"v1beta", "admin", "operator-definitions", "permalink", "lookUp"}, ""))
	...
	pattern_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 2, 5, 3, 2, 4}, []string{"v1beta", "admin", "connector-definitions", "permalink", "lookUp"}, ""))
...
var (
	...
	forward_PipelinePrivateService_LookUpConnectorDefinitionAdmin_0 = runtime.ForwardResponseMessage
