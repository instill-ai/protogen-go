...
var (
	filter_PipelinePublicService_ListPipelineRunsByCreditOwner_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_PipelinePublicService_ListPipelineRunsByCreditOwner_0(ctx context.Context, marshaler runtime.Marshaler, client PipelinePublicServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListPipelineRunsByCreditOwnerRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PipelinePublicService_ListPipelineRunsByCreditOwner_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ListPipelineRunsByCreditOwner(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PipelinePublicService_ListPipelineRunsByCreditOwner_0(ctx context.Context, marshaler runtime.Marshaler, server PipelinePublicServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListPipelineRunsByCreditOwnerRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListPipelineRunsByCreditOwner(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterPipelinePublicServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelinePublicServiceServer) error {
	...
	mux.Handle("GET", pattern_PipelinePublicService_ListPipelineRunsByCreditOwner_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePublicService/ListPipelineRunsByCreditOwner", runtime.WithHTTPPathPattern("/v1beta/dashboard/pipelines/runs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelinePublicService_ListPipelineRunsByCreditOwner_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelinePublicService_ListPipelineRunsByCreditOwner_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPipelinePublicServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelinePublicServiceClient) error {
	...
	mux.Handle("GET", pattern_PipelinePublicService_ListPipelineRunsByCreditOwner_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePublicService/ListPipelineRunsByCreditOwner", runtime.WithHTTPPathPattern("/v1beta/dashboard/pipelines/runs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelinePublicService_ListPipelineRunsByCreditOwner_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_PipelinePublicService_ListPipelineRunsByCreditOwner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1beta", "dashboard", "pipelines", "runs"}, ""))
...
var (
	...
	forward_PipelinePublicService_ListPipelineRunsByCreditOwner_0 = runtime.ForwardResponseMessage
