...
var (
	filter_PipelinePublicService_SendUserPipelineEvent_0 = &utilities.DoubleArray{Encoding: map[string]int{"data": 0, "name": 1}, Base: []int{1, 2, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 2, 2, 3, 3}}
)

func request_PipelinePublicService_SendUserPipelineEvent_0(ctx context.Context, marshaler runtime.Marshaler, client PipelinePublicServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SendUserPipelineEventRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PipelinePublicService_SendUserPipelineEvent_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.SendUserPipelineEvent(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PipelinePublicService_SendUserPipelineEvent_0(ctx context.Context, marshaler runtime.Marshaler, server PipelinePublicServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SendUserPipelineEventRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SendUserPipelineEvent(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_PipelinePublicService_SendOrganizationPipelineEvent_0 = &utilities.DoubleArray{Encoding: map[string]int{"data": 0, "name": 1}, Base: []int{1, 2, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 2, 2, 3, 3}}
)

func request_PipelinePublicService_SendOrganizationPipelineEvent_0(ctx context.Context, marshaler runtime.Marshaler, client PipelinePublicServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SendOrganizationPipelineEventRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PipelinePublicService_SendOrganizationPipelineEvent_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.SendOrganizationPipelineEvent(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PipelinePublicService_SendOrganizationPipelineEvent_0(ctx context.Context, marshaler runtime.Marshaler, server PipelinePublicServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SendOrganizationPipelineEventRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SendOrganizationPipelineEvent(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterPipelinePublicServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelinePublicServiceServer) error {
	...
	mux.Handle("POST", pattern_PipelinePublicService_SendUserPipelineEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePublicService/SendUserPipelineEvent", runtime.WithHTTPPathPattern("/v1beta/{name=users/*/pipelines/*}/events"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelinePublicService_SendUserPipelineEvent_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelinePublicService_SendUserPipelineEvent_0(annotatedContext, mux, outboundMarshaler, w, req, response_PipelinePublicService_SendUserPipelineEvent_0{resp}, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_PipelinePublicService_SendOrganizationPipelineEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePublicService/SendOrganizationPipelineEvent", runtime.WithHTTPPathPattern("/v1beta/{name=organizations/*/pipelines/*}/events"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelinePublicService_SendOrganizationPipelineEvent_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelinePublicService_SendOrganizationPipelineEvent_0(annotatedContext, mux, outboundMarshaler, w, req, response_PipelinePublicService_SendOrganizationPipelineEvent_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterPipelinePublicServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelinePublicServiceClient) error {
	...
	mux.Handle("POST", pattern_PipelinePublicService_SendUserPipelineEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePublicService/SendUserPipelineEvent", runtime.WithHTTPPathPattern("/v1beta/{name=users/*/pipelines/*}/events"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelinePublicService_SendUserPipelineEvent_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_PipelinePublicService_SendOrganizationPipelineEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1beta.PipelinePublicService/SendOrganizationPipelineEvent", runtime.WithHTTPPathPattern("/v1beta/{name=organizations/*/pipelines/*}/events"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelinePublicService_SendOrganizationPipelineEvent_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_PipelinePublicService_SendUserPipelineEvent_0 struct {
	proto.Message
}

func (m response_PipelinePublicService_SendUserPipelineEvent_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*SendUserPipelineEventResponse)
	return response.Data
}

type response_PipelinePublicService_SendOrganizationPipelineEvent_0 struct {
	proto.Message
}

func (m response_PipelinePublicService_SendOrganizationPipelineEvent_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*SendOrganizationPipelineEventResponse)
	return response.Data
}
...
var (
	...
	pattern_PipelinePublicService_SendUserPipelineEvent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3, 2, 4}, []string{"v1beta", "users", "pipelines", "name", "events"}, ""))

	pattern_PipelinePublicService_SendOrganizationPipelineEvent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3, 2, 4}, []string{"v1beta", "organizations", "pipelines", "name", "events"}, ""))
...
var (
	...
	forward_PipelinePublicService_SendUserPipelineEvent_0 = runtime.ForwardResponseMessage

	forward_PipelinePublicService_SendOrganizationPipelineEvent_0 = runtime.ForwardResponseMessage
