...
type ListConnectorDefinitionsRequest_View int32

const (
	// View: UNSPECIFIED
	ListConnectorDefinitionsRequest_VIEW_UNSPECIFIED ListConnectorDefinitionsRequest_View = 0
	// View: BASIC
	ListConnectorDefinitionsRequest_VIEW_BASIC ListConnectorDefinitionsRequest_View = 1
	// View: FULL
	ListConnectorDefinitionsRequest_VIEW_FULL ListConnectorDefinitionsRequest_View = 2
)

// Enum value maps for ListConnectorDefinitionsRequest_View.
var (
	ListConnectorDefinitionsRequest_View_name = map[int32]string{
		0: "VIEW_UNSPECIFIED",
		1: "VIEW_BASIC",
		2: "VIEW_FULL",
	}
	ListConnectorDefinitionsRequest_View_value = map[string]int32{
		"VIEW_UNSPECIFIED": 0,
		"VIEW_BASIC":       1,
		"VIEW_FULL":        2,
	}
...
func (x ListConnectorDefinitionsRequest_View) Enum() *ListConnectorDefinitionsRequest_View {
	p := new(ListConnectorDefinitionsRequest_View)
	*p = x
	return p
}

func (x ListConnectorDefinitionsRequest_View) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ListConnectorDefinitionsRequest_View) Descriptor() protoreflect.EnumDescriptor {
	return file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes[1].Descriptor()
}

func (ListConnectorDefinitionsRequest_View) Type() protoreflect.EnumType {
	return &file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes[1]
}

func (x ListConnectorDefinitionsRequest_View) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ListConnectorDefinitionsRequest_View.Descriptor instead.
func (ListConnectorDefinitionsRequest_View) EnumDescriptor() ([]byte, []int) {
	return file_vdp_pipeline_v1alpha_connector_definition_proto_rawDescGZIP(), []int{2, 0}
}

// View enumerates the definition views
type GetConnectorDefinitionRequest_View int32

const (
	// View: UNSPECIFIED
	GetConnectorDefinitionRequest_VIEW_UNSPECIFIED GetConnectorDefinitionRequest_View = 0
	// View: BASIC
	GetConnectorDefinitionRequest_VIEW_BASIC GetConnectorDefinitionRequest_View = 1
	// View: FULL
	GetConnectorDefinitionRequest_VIEW_FULL GetConnectorDefinitionRequest_View = 2
)

// Enum value maps for GetConnectorDefinitionRequest_View.
var (
	GetConnectorDefinitionRequest_View_name = map[int32]string{
		0: "VIEW_UNSPECIFIED",
		1: "VIEW_BASIC",
		2: "VIEW_FULL",
	}
	GetConnectorDefinitionRequest_View_value = map[string]int32{
		"VIEW_UNSPECIFIED": 0,
		"VIEW_BASIC":       1,
		"VIEW_FULL":        2,
	}
...
func (x GetConnectorDefinitionRequest_View) Enum() *GetConnectorDefinitionRequest_View {
	p := new(GetConnectorDefinitionRequest_View)
	*p = x
	return p
}

func (x GetConnectorDefinitionRequest_View) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GetConnectorDefinitionRequest_View) Descriptor() protoreflect.EnumDescriptor {
	return file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes[2].Descriptor()
}

func (GetConnectorDefinitionRequest_View) Type() protoreflect.EnumType {
	return &file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes[2]
}

func (x GetConnectorDefinitionRequest_View) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GetConnectorDefinitionRequest_View.Descriptor instead.
func (GetConnectorDefinitionRequest_View) EnumDescriptor() ([]byte, []int) {
	return file_vdp_pipeline_v1alpha_connector_definition_proto_rawDescGZIP(), []int{4, 0}
}

// View enumerates the definition views
type LookUpConnectorDefinitionAdminRequest_View int32

const (
	// View: UNSPECIFIED
	LookUpConnectorDefinitionAdminRequest_VIEW_UNSPECIFIED LookUpConnectorDefinitionAdminRequest_View = 0
	// View: BASIC
	LookUpConnectorDefinitionAdminRequest_VIEW_BASIC LookUpConnectorDefinitionAdminRequest_View = 1
	// View: FULL
	LookUpConnectorDefinitionAdminRequest_VIEW_FULL LookUpConnectorDefinitionAdminRequest_View = 2
)

// Enum value maps for LookUpConnectorDefinitionAdminRequest_View.
var (
	LookUpConnectorDefinitionAdminRequest_View_name = map[int32]string{
		0: "VIEW_UNSPECIFIED",
		1: "VIEW_BASIC",
		2: "VIEW_FULL",
	}
	LookUpConnectorDefinitionAdminRequest_View_value = map[string]int32{
		"VIEW_UNSPECIFIED": 0,
		"VIEW_BASIC":       1,
		"VIEW_FULL":        2,
	}
...
func (x LookUpConnectorDefinitionAdminRequest_View) Enum() *LookUpConnectorDefinitionAdminRequest_View {
	p := new(LookUpConnectorDefinitionAdminRequest_View)
	*p = x
	return p
}

func (x LookUpConnectorDefinitionAdminRequest_View) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LookUpConnectorDefinitionAdminRequest_View) Descriptor() protoreflect.EnumDescriptor {
	return file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes[3].Descriptor()
}

func (LookUpConnectorDefinitionAdminRequest_View) Type() protoreflect.EnumType {
	return &file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes[3]
}

func (x LookUpConnectorDefinitionAdminRequest_View) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LookUpConnectorDefinitionAdminRequest_View.Descriptor instead.
func (LookUpConnectorDefinitionAdminRequest_View) EnumDescriptor() ([]byte, []int) {
	return file_vdp_pipeline_v1alpha_connector_definition_proto_rawDescGZIP(), []int{6, 0}
}
...
type ListConnectorDefinitionsRequest struct {
	...
	View *ListConnectorDefinitionsRequest_View `protobuf:"varint,3,opt,name=view,proto3,enum=vdp.pipeline.v1alpha.ListConnectorDefinitionsRequest_View,oneof" json:"view,omitempty"`
...
func (x *ListConnectorDefinitionsRequest) GetView() ListConnectorDefinitionsRequest_View {
	if x != nil && x.View != nil {
		return *x.View
	}
	return ListConnectorDefinitionsRequest_VIEW_UNSPECIFIED
}
...
type GetConnectorDefinitionRequest struct {
	...
	View *GetConnectorDefinitionRequest_View `protobuf:"varint,2,opt,name=view,proto3,enum=vdp.pipeline.v1alpha.GetConnectorDefinitionRequest_View,oneof" json:"view,omitempty"`
}
...
func (x *GetConnectorDefinitionRequest) GetView() GetConnectorDefinitionRequest_View {
	if x != nil && x.View != nil {
		return *x.View
	}
	return GetConnectorDefinitionRequest_VIEW_UNSPECIFIED
}
...
type LookUpConnectorDefinitionAdminRequest struct {
	...
	View *LookUpConnectorDefinitionAdminRequest_View `protobuf:"varint,2,opt,name=view,proto3,enum=vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminRequest_View,oneof" json:"view,omitempty"`
}
...
func (x *LookUpConnectorDefinitionAdminRequest) GetView() LookUpConnectorDefinitionAdminRequest_View {
	if x != nil && x.View != nil {
		return *x.View
	}
	return LookUpConnectorDefinitionAdminRequest_VIEW_UNSPECIFIED
}
...
var file_vdp_pipeline_v1alpha_connector_definition_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x22, 0xfa, 0x04, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	...
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x3a, 0x57, 0xea, 0x41, 0x54, 0x0a, 0x24, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2d, 0x64,
	0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x7b, 0x63, 0x6f, 0x6e, 0x6e,
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x2d, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x7d, 0x22, 0xdb, 0x02, 0x0a, 0x1f, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	...
	0x65, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x58, 0x0a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x3a, 0x2e, 0x76, 0x64, 0x70, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x56, 0x69, 0x65, 0x77, 0x42,
	...
	0x01, 0x22, 0x3b, 0x0a, 0x04, 0x56, 0x69, 0x65, 0x77, 0x12, 0x14, 0x0a, 0x10, 0x56, 0x49, 0x45,
	...
	0x0d, 0x0a, 0x09, 0x56, 0x49, 0x45, 0x57, 0x5f, 0x46, 0x55, 0x4c, 0x4c, 0x10, 0x02, 0x42, 0x0c,
	...
	0xc9, 0x01, 0x0a, 0x20, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f,
	0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5e, 0x0a, 0x15, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f,
	...
	0x6e, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x14,
	...
	0x52, 0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xa1, 0x02, 0x0a, 0x1d,
	0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x66, 0x69,
	0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x62, 0x0a,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x4e, 0x92, 0x41, 0x1f,
	0xca, 0x3e, 0x1c, 0xfa, 0x02, 0x19, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f,
	...
	0x65, 0x12, 0x56, 0x0a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x7e, 0x0a, 0x1e, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x44,
	0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x5c, 0x0a, 0x14, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x64,
	...
	0x02, 0x52, 0x09, 0x70, 0x65, 0x72, 0x6d, 0x61, 0x6c, 0x69, 0x6e, 0x6b, 0x12, 0x5e, 0x0a, 0x04,
	0x76, 0x69, 0x65, 0x77, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x40, 0x2e, 0x76, 0x64, 0x70,
	...
	0x01, 0x48, 0x00, 0x52, 0x04, 0x76, 0x69, 0x65, 0x77, 0x88, 0x01, 0x01, 0x22, 0x3b, 0x0a, 0x04,
	...
	0x45, 0x57, 0x5f, 0x46, 0x55, 0x4c, 0x4c, 0x10, 0x02, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x76, 0x69,
	0x65, 0x77, 0x22, 0x86, 0x01, 0x0a, 0x26, 0x4c, 0x6f, 0x6f, 0x6b, 0x55, 0x70, 0x43, 0x6f, 0x6e,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x76, 0x64,
	0x70, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x2e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x66, 0x69,
	0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x13, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f,
	0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0xd6, 0x01, 0x0a, 0x0d,
	...
	,
...
var file_vdp_pipeline_v1alpha_connector_definition_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_vdp_pipeline_v1alpha_connector_definition_proto_goTypes = []interface{}{
	...
	(ListConnectorDefinitionsRequest_View)(0),       // 1: vdp.pipeline.v1alpha.ListConnectorDefinitionsRequest.View
	(GetConnectorDefinitionRequest_View)(0),         // 2: vdp.pipeline.v1alpha.GetConnectorDefinitionRequest.View
	(LookUpConnectorDefinitionAdminRequest_View)(0), // 3: vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminRequest.View
	(*ConnectorSpec)(nil),                           // 4: vdp.pipeline.v1alpha.ConnectorSpec
	(*ConnectorDefinition)(nil),                     // 5: vdp.pipeline.v1alpha.ConnectorDefinition
	(*ListConnectorDefinitionsRequest)(nil),         // 6: vdp.pipeline.v1alpha.ListConnectorDefinitionsRequest
	(*ListConnectorDefinitionsResponse)(nil),        // 7: vdp.pipeline.v1alpha.ListConnectorDefinitionsResponse
	(*GetConnectorDefinitionRequest)(nil),           // 8: vdp.pipeline.v1alpha.GetConnectorDefinitionRequest
	(*GetConnectorDefinitionResponse)(nil),          // 9: vdp.pipeline.v1alpha.GetConnectorDefinitionResponse
	(*LookUpConnectorDefinitionAdminRequest)(nil),   // 10: vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminRequest
	(*LookUpConnectorDefinitionAdminResponse)(nil),  // 11: vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminResponse
	(*structpb.Struct)(nil),                         // 12: google.protobuf.Struct
}
var file_vdp_pipeline_v1alpha_connector_definition_proto_depIdxs = []int32{
	12, // 0: vdp.pipeline.v1alpha.ConnectorSpec.resource_specification:type_name -> google.protobuf.Struct
	12, // 1: vdp.pipeline.v1alpha.ConnectorSpec.component_specification:type_name -> google.protobuf.Struct
	12, // 2: vdp.pipeline.v1alpha.ConnectorSpec.openapi_specifications:type_name -> google.protobuf.Struct
	4,  // 3: vdp.pipeline.v1alpha.ConnectorDefinition.spec:type_name -> vdp.pipeline.v1alpha.ConnectorSpec
	0,  // 4: vdp.pipeline.v1alpha.ConnectorDefinition.type:type_name -> vdp.pipeline.v1alpha.ConnectorType
	12, // 5: vdp.pipeline.v1alpha.ConnectorDefinition.vendor_attributes:type_name -> google.protobuf.Struct
	1,  // 6: vdp.pipeline.v1alpha.ListConnectorDefinitionsRequest.view:type_name -> vdp.pipeline.v1alpha.ListConnectorDefinitionsRequest.View
	5,  // 7: vdp.pipeline.v1alpha.ListConnectorDefinitionsResponse.connector_definitions:type_name -> vdp.pipeline.v1alpha.ConnectorDefinition
	2,  // 8: vdp.pipeline.v1alpha.GetConnectorDefinitionRequest.view:type_name -> vdp.pipeline.v1alpha.GetConnectorDefinitionRequest.View
	5,  // 9: vdp.pipeline.v1alpha.GetConnectorDefinitionResponse.connector_definition:type_name -> vdp.pipeline.v1alpha.ConnectorDefinition
	3,  // 10: vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminRequest.view:type_name -> vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminRequest.View
	5,  // 11: vdp.pipeline.v1alpha.LookUpConnectorDefinitionAdminResponse.connector_definition:type_name -> vdp.pipeline.v1alpha.ConnectorDefinition
