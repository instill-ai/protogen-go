...
var (
	filter_PipelinePrivateService_GetPipelineAdmin_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)

func request_PipelinePrivateService_GetPipelineAdmin_0(ctx context.Context, marshaler runtime.Marshaler, client PipelinePrivateServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetPipelineAdminRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PipelinePrivateService_GetPipelineAdmin_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetPipelineAdmin(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PipelinePrivateService_GetPipelineAdmin_0(ctx context.Context, marshaler runtime.Marshaler, server PipelinePrivateServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetPipelineAdminRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetPipelineAdmin(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterPipelinePrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelinePrivateServiceServer) error {
	...
	mux.Handle("GET", pattern_PipelinePrivateService_GetPipelineAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/vdp.pipeline.v1alpha.PipelinePrivateService/GetPipelineAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=pipelines/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelinePrivateService_GetPipelineAdmin_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelinePrivateService_GetPipelineAdmin_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPipelinePrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelinePrivateServiceClient) error {
	...
	mux.Handle("GET", pattern_PipelinePrivateService_GetPipelineAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/vdp.pipeline.v1alpha.PipelinePrivateService/GetPipelineAdmin", runtime.WithHTTPPathPattern("/v1alpha/admin/{name=pipelines/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelinePrivateService_GetPipelineAdmin_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_PipelinePrivateService_GetPipelineAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 2, 5, 3}, []string{"v1alpha", "admin", "pipelines", "name"}, ""))
...
var (
	...
	forward_PipelinePrivateService_GetPipelineAdmin_0 = runtime.ForwardResponseMessage
