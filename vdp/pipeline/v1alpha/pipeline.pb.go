...
type Pipeline struct {
	...
	// OpenAPI schema
	OpenapiSchema []*structpb.Struct `protobuf:"bytes,13,rep,name=openapi_schema,json=openapiSchema,proto3" json:"openapi_schema,omitempty"`
}
...
type PipelineRelease struct {
	...
	// OpenAPI schema
	OpenapiSchema []*structpb.Struct `protobuf:"bytes,9,rep,name=openapi_schema,json=openapiSchema,proto3" json:"openapi_schema,omitempty"`
}
...
var file_vdp_pipeline_v1alpha_pipeline_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f,
	...
	0x61, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
