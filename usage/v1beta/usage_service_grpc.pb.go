...
const (
	UsageService_Liveness_FullMethodName          = "/usage.v1beta.UsageService/Liveness"
	UsageService_Readiness_FullMethodName         = "/usage.v1beta.UsageService/Readiness"
	UsageService_CreateSession_FullMethodName     = "/usage.v1beta.UsageService/CreateSession"
	UsageService_SendSessionReport_FullMethodName = "/usage.v1beta.UsageService/SendSessionReport"
)
...
func (c *usageServiceClient) Liveness(ctx context.Context, in *LivenessRequest, opts ...grpc.CallOption) (*LivenessResponse, error) {
	...
	err := c.cc.Invoke(ctx, UsageService_Liveness_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usageServiceClient) Readiness(ctx context.Context, in *ReadinessRequest, opts ...grpc.CallOption) (*ReadinessResponse, error) {
	...
	err := c.cc.Invoke(ctx, UsageService_Readiness_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usageServiceClient) CreateSession(ctx context.Context, in *CreateSessionRequest, opts ...grpc.CallOption) (*CreateSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, UsageService_CreateSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usageServiceClient) SendSessionReport(ctx context.Context, in *SendSessionReportRequest, opts ...grpc.CallOption) (*SendSessionReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, UsageService_SendSessionReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UsageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "usage.v1beta.UsageService",
	...
	Metadata: "usage/v1beta/usage_service.proto",
}
