...
var (
	filter_ModelPublicService_ListModelTriggers_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_ModelPublicService_ListModelTriggers_0(ctx context.Context, marshaler runtime.Marshaler, client ModelPublicServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListModelTriggersRequest
	var metadata runtime.ServerMetadata
...
func RegisterModelPublicServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ModelPublicServiceServer) error {
	...
	mux.Handle("GET", pattern_ModelPublicService_ListModelTriggers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/model.model.v1alpha.ModelPublicService/ListModelTriggers", runtime.WithHTTPPathPattern("/v1alpha/model-triggers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterModelPublicServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ModelPublicServiceClient) error {
	...
	mux.Handle("GET", pattern_ModelPublicService_ListModelTriggers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/model.model.v1alpha.ModelPublicService/ListModelTriggers", runtime.WithHTTPPathPattern("/v1alpha/model-triggers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_ModelPublicService_ListModelTriggers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1alpha", "model-triggers"}, ""))
)
