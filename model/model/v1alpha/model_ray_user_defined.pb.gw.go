...
func RegisterRayUserDefinedServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RayUserDefinedServiceServer) error {
	...
	mux.Handle("POST", pattern_RayUserDefinedService_XCall___0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/model.model.v1alpha.RayUserDefinedService/XCall__", runtime.WithHTTPPathPattern("/model.model.v1alpha.RayUserDefinedService/__call__"))
		if err != nil {
...
// "RayUserDefinedServiceClient" to call the correct interceptors.
func RegisterRayUserDefinedServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RayUserDefinedServiceClient) error {
	...
	mux.Handle("POST", pattern_RayUserDefinedService_XCall___0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/model.model.v1alpha.RayUserDefinedService/XCall__", runtime.WithHTTPPathPattern("/model.model.v1alpha.RayUserDefinedService/__call__"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_RayUserDefinedService_XCall___0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"model.model.v1alpha.RayUserDefinedService", "__call__"}, ""))
)
