...
type ModelPublicServiceClient interface {
	...
	// List model triggers
	//
	// Returns a paginated list of model triggers
	ListModelTriggers(ctx context.Context, in *ListModelTriggersRequest, opts ...grpc.CallOption) (*ListModelTriggersResponse, error)
}
...
func (c *modelPublicServiceClient) ListModelTriggers(ctx context.Context, in *ListModelTriggersRequest, opts ...grpc.CallOption) (*ListModelTriggersResponse, error) {
	out := new(ListModelTriggersResponse)
...
type ModelPublicServiceServer interface {
	...
	//
	// Returns a paginated list of model triggers
	ListModelTriggers(context.Context, *ListModelTriggersRequest) (*ListModelTriggersResponse, error)
}
...
func (UnimplementedModelPublicServiceServer) ListModelTriggers(context.Context, *ListModelTriggersRequest) (*ListModelTriggersResponse, error) {
...
func _ModelPublicService_ListModelTriggers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListModelTriggersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ModelPublicServiceServer).ListModelTriggers(ctx, req.(*ListModelTriggersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
