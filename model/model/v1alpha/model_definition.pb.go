...
const file_model_model_v1alpha_model_definition_proto_rawDesc = "" +
	"\n" +
	...
	"\rrelease_stage\x18\a \x01(\x0e2!.model.model.v1alpha.ReleaseStageB\x03\xe0A\x03R\freleaseStage\x12;\n" +
	"\n" +
	...
	"updateTime:4\xeaA1\x12\x16model-definitions/{id}\x12\x17model-definitions/{uid}\"\xcc\x01\n" +
	...
	"\x04view\x18\x03 \x01(\x0e2\x19.model.model.v1alpha.ViewB\x03\xe0A\x01H\x02R\x04view\x88\x01\x01B\f\n" +
	"\n" +
	"_page_sizeB\r\n" +
	"\v_page_tokenB\a\n" +
	"\x05_view\"\xb8\x01\n" +
	"\x1cListModelDefinitionsResponse\x12Q\n" +
	"\x11model_definitions\x18\x01 \x03(\v2$.model.model.v1alpha.ModelDefinitionR\x10modelDefinitions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\x98\x01\n" +
	"\x19GetModelDefinitionRequest\x127\n" +
	"\x04view\x18\x02 \x01(\x0e2\x19.model.model.v1alpha.ViewB\x03\xe0A\x01H\x00R\x04view\x88\x01\x01\x123\n" +
	...
	"\x10model_definition\x18\x01 \x01(\v2$.model.model.v1alpha.ModelDefinitionB\x03\xe0A\x03R\x0fmodelDefinition*\x9f\x01\n" +
	...
	"\tVIEW_FULL\x10\x02B\xe1\x01\n" +
	"\x17com.model.model.v1alphaB\x14ModelDefinitionProtoP\x01ZBgithub.com/instill-ai/protogen-go/model/model/v1alpha;modelv1alpha\xa2\x02\x03MMX\xaa\x02\x13Model.Model.V1alpha\xca\x02\x13Model\\Model\\V1alpha\xe2\x02\x1fModel\\Model\\V1alpha\\GPBMetadata\xea\x02\x15Model::Model::V1alphab\x06proto3"

var (
	file_model_model_v1alpha_model_definition_proto_rawDescOnce sync.Once
	file_model_model_v1alpha_model_definition_proto_rawDescData []byte
)
...
func file_model_model_v1alpha_model_definition_proto_rawDescGZIP() []byte {
	file_model_model_v1alpha_model_definition_proto_rawDescOnce.Do(func() {
		file_model_model_v1alpha_model_definition_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_model_model_v1alpha_model_definition_proto_rawDesc), len(file_model_model_v1alpha_model_definition_proto_rawDesc)))
	})
...
var file_model_model_v1alpha_model_definition_proto_goTypes = []any{
...
func file_model_model_v1alpha_model_definition_proto_init() {
	...
	file_model_model_v1alpha_model_definition_proto_msgTypes[1].OneofWrappers = []any{}
	file_model_model_v1alpha_model_definition_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_model_model_v1alpha_model_definition_proto_rawDesc), len(file_model_model_v1alpha_model_definition_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
