...
func (x *VisualQuestionAnsweringInput) GetChatHistory() []*Content {
	if x != nil {
...
var file_model_model_v1alpha_task_visual_question_answering_proto_rawDesc = []byte{
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x03,
...
var file_model_model_v1alpha_task_visual_question_answering_proto_depIdxs = []int32{
	...
	3, // 1: model.model.v1alpha.VisualQuestionAnsweringInput.chat_history:type_name -> model.model.v1alpha.Content
