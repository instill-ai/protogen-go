...
var file_model_model_v1alpha_model_proto_goTypes = []interface{}{
	...
	(*Permission)(nil),                                       // 91: model.model.v1alpha.Permission
	(View)(0),                                                // 92: model.model.v1alpha.View
	(*fieldmaskpb.FieldMask)(nil),                            // 93: google.protobuf.FieldMask
	(*ClassificationInput)(nil),                              // 94: model.model.v1alpha.ClassificationInput
	(*DetectionInput)(nil),                                   // 95: model.model.v1alpha.DetectionInput
	(*KeypointInput)(nil),                                    // 96: model.model.v1alpha.KeypointInput
	(*OcrInput)(nil),                                         // 97: model.model.v1alpha.OcrInput
	(*InstanceSegmentationInput)(nil),                        // 98: model.model.v1alpha.InstanceSegmentationInput
	(*SemanticSegmentationInput)(nil),                        // 99: model.model.v1alpha.SemanticSegmentationInput
	(*TextToImageInput)(nil),                                 // 100: model.model.v1alpha.TextToImageInput
	(*ImageToImageInput)(nil),                                // 101: model.model.v1alpha.ImageToImageInput
	(*TextGenerationInput)(nil),                              // 102: model.model.v1alpha.TextGenerationInput
	(*TextGenerationChatInput)(nil),                          // 103: model.model.v1alpha.TextGenerationChatInput
	(*VisualQuestionAnsweringInput)(nil),                     // 104: model.model.v1alpha.VisualQuestionAnsweringInput
	(*UnspecifiedInput)(nil),                                 // 105: model.model.v1alpha.UnspecifiedInput
	(*ClassificationInputStream)(nil),                        // 106: model.model.v1alpha.ClassificationInputStream
	(*DetectionInputStream)(nil),                             // 107: model.model.v1alpha.DetectionInputStream
	(*KeypointInputStream)(nil),                              // 108: model.model.v1alpha.KeypointInputStream
	(*OcrInputStream)(nil),                                   // 109: model.model.v1alpha.OcrInputStream
	(*InstanceSegmentationInputStream)(nil),                  // 110: model.model.v1alpha.InstanceSegmentationInputStream
	(*SemanticSegmentationInputStream)(nil),                  // 111: model.model.v1alpha.SemanticSegmentationInputStream
	(*ClassificationOutput)(nil),                             // 112: model.model.v1alpha.ClassificationOutput
	(*DetectionOutput)(nil),                                  // 113: model.model.v1alpha.DetectionOutput
	(*KeypointOutput)(nil),                                   // 114: model.model.v1alpha.KeypointOutput
	(*OcrOutput)(nil),                                        // 115: model.model.v1alpha.OcrOutput
	(*InstanceSegmentationOutput)(nil),                       // 116: model.model.v1alpha.InstanceSegmentationOutput
	(*SemanticSegmentationOutput)(nil),                       // 117: model.model.v1alpha.SemanticSegmentationOutput
	(*TextToImageOutput)(nil),                                // 118: model.model.v1alpha.TextToImageOutput
	(*ImageToImageOutput)(nil),                               // 119: model.model.v1alpha.ImageToImageOutput
	(*TextGenerationOutput)(nil),                             // 120: model.model.v1alpha.TextGenerationOutput
	(*TextGenerationChatOutput)(nil),                         // 121: model.model.v1alpha.TextGenerationChatOutput
	(*VisualQuestionAnsweringOutput)(nil),                    // 122: model.model.v1alpha.VisualQuestionAnsweringOutput
	(*UnspecifiedOutput)(nil),                                // 123: model.model.v1alpha.UnspecifiedOutput
...
var file_model_model_v1alpha_model_proto_depIdxs = []int32{
	...
	91,  // 15: model.model.v1alpha.Model.permission:type_name -> model.model.v1alpha.Permission
	88,  // 16: model.model.v1alpha.Model.input_schema:type_name -> google.protobuf.Struct
	88,  // 17: model.model.v1alpha.Model.output_schema:type_name -> google.protobuf.Struct
	92,  // 18: model.model.v1alpha.ListModelsRequest.view:type_name -> model.model.v1alpha.View
	...
	92,  // 21: model.model.v1alpha.LookUpModelRequest.view:type_name -> model.model.v1alpha.View
	...
	92,  // 25: model.model.v1alpha.ListUserModelsRequest.view:type_name -> model.model.v1alpha.View
	...
	92,  // 28: model.model.v1alpha.GetUserModelRequest.view:type_name -> model.model.v1alpha.View
	...
	93,  // 31: model.model.v1alpha.UpdateUserModelRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	94,  // 39: model.model.v1alpha.TaskInput.classification:type_name -> model.model.v1alpha.ClassificationInput
	95,  // 40: model.model.v1alpha.TaskInput.detection:type_name -> model.model.v1alpha.DetectionInput
	96,  // 41: model.model.v1alpha.TaskInput.keypoint:type_name -> model.model.v1alpha.KeypointInput
	97,  // 42: model.model.v1alpha.TaskInput.ocr:type_name -> model.model.v1alpha.OcrInput
	98,  // 43: model.model.v1alpha.TaskInput.instance_segmentation:type_name -> model.model.v1alpha.InstanceSegmentationInput
	99,  // 44: model.model.v1alpha.TaskInput.semantic_segmentation:type_name -> model.model.v1alpha.SemanticSegmentationInput
	100, // 45: model.model.v1alpha.TaskInput.text_to_image:type_name -> model.model.v1alpha.TextToImageInput
	101, // 46: model.model.v1alpha.TaskInput.image_to_image:type_name -> model.model.v1alpha.ImageToImageInput
	102, // 47: model.model.v1alpha.TaskInput.text_generation:type_name -> model.model.v1alpha.TextGenerationInput
	103, // 48: model.model.v1alpha.TaskInput.text_generation_chat:type_name -> model.model.v1alpha.TextGenerationChatInput
	104, // 49: model.model.v1alpha.TaskInput.visual_question_answering:type_name -> model.model.v1alpha.VisualQuestionAnsweringInput
	105, // 50: model.model.v1alpha.TaskInput.unspecified:type_name -> model.model.v1alpha.UnspecifiedInput
	106, // 51: model.model.v1alpha.TaskInputStream.classification:type_name -> model.model.v1alpha.ClassificationInputStream
	107, // 52: model.model.v1alpha.TaskInputStream.detection:type_name -> model.model.v1alpha.DetectionInputStream
	108, // 53: model.model.v1alpha.TaskInputStream.keypoint:type_name -> model.model.v1alpha.KeypointInputStream
	109, // 54: model.model.v1alpha.TaskInputStream.ocr:type_name -> model.model.v1alpha.OcrInputStream
	110, // 55: model.model.v1alpha.TaskInputStream.instance_segmentation:type_name -> model.model.v1alpha.InstanceSegmentationInputStream
	111, // 56: model.model.v1alpha.TaskInputStream.semantic_segmentation:type_name -> model.model.v1alpha.SemanticSegmentationInputStream
	100, // 57: model.model.v1alpha.TaskInputStream.text_to_image:type_name -> model.model.v1alpha.TextToImageInput
	101, // 58: model.model.v1alpha.TaskInputStream.image_to_image:type_name -> model.model.v1alpha.ImageToImageInput
	102, // 59: model.model.v1alpha.TaskInputStream.text_generation:type_name -> model.model.v1alpha.TextGenerationInput
	103, // 60: model.model.v1alpha.TaskInputStream.text_generation_chat:type_name -> model.model.v1alpha.TextGenerationChatInput
	104, // 61: model.model.v1alpha.TaskInputStream.visual_question_answering:type_name -> model.model.v1alpha.VisualQuestionAnsweringInput
	105, // 62: model.model.v1alpha.TaskInputStream.unspecified:type_name -> model.model.v1alpha.UnspecifiedInput
	112, // 63: model.model.v1alpha.TaskOutput.classification:type_name -> model.model.v1alpha.ClassificationOutput
	113, // 64: model.model.v1alpha.TaskOutput.detection:type_name -> model.model.v1alpha.DetectionOutput
	114, // 65: model.model.v1alpha.TaskOutput.keypoint:type_name -> model.model.v1alpha.KeypointOutput
	115, // 66: model.model.v1alpha.TaskOutput.ocr:type_name -> model.model.v1alpha.OcrOutput
	116, // 67: model.model.v1alpha.TaskOutput.instance_segmentation:type_name -> model.model.v1alpha.InstanceSegmentationOutput
	117, // 68: model.model.v1alpha.TaskOutput.semantic_segmentation:type_name -> model.model.v1alpha.SemanticSegmentationOutput
	118, // 69: model.model.v1alpha.TaskOutput.text_to_image:type_name -> model.model.v1alpha.TextToImageOutput
	119, // 70: model.model.v1alpha.TaskOutput.image_to_image:type_name -> model.model.v1alpha.ImageToImageOutput
	120, // 71: model.model.v1alpha.TaskOutput.text_generation:type_name -> model.model.v1alpha.TextGenerationOutput
	121, // 72: model.model.v1alpha.TaskOutput.text_generation_chat:type_name -> model.model.v1alpha.TextGenerationChatOutput
	122, // 73: model.model.v1alpha.TaskOutput.visual_question_answering:type_name -> model.model.v1alpha.VisualQuestionAnsweringOutput
	123, // 74: model.model.v1alpha.TaskOutput.unspecified:type_name -> model.model.v1alpha.UnspecifiedOutput
	36,  // 75: model.model.v1alpha.TriggerUserModelRequest.task_inputs:type_name -> model.model.v1alpha.TaskInput
	89,  // 76: model.model.v1alpha.TriggerUserModelResponse.task:type_name -> common.task.v1alpha.Task
	...
	124, // 79: model.model.v1alpha.TriggerAsyncUserModelResponse.operation:type_name -> google.longrunning.Operation
	37,  // 80: model.model.v1alpha.TriggerUserModelBinaryFileUploadRequest.task_input:type_name -> model.model.v1alpha.TaskInputStream
	89,  // 81: model.model.v1alpha.TriggerUserModelBinaryFileUploadResponse.task:type_name -> common.task.v1alpha.Task
	38,  // 82: model.model.v1alpha.TriggerUserModelBinaryFileUploadResponse.task_outputs:type_name -> model.model.v1alpha.TaskOutput
	...
	92,  // 85: model.model.v1alpha.ListOrganizationModelsRequest.view:type_name -> model.model.v1alpha.View
	...
	92,  // 88: model.model.v1alpha.GetOrganizationModelRequest.view:type_name -> model.model.v1alpha.View
	...
	93,  // 91: model.model.v1alpha.UpdateOrganizationModelRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	8,   // 94: model.model.v1alpha.PublishOrganizationModelResponse.model:type_name -> model.model.v1alpha.Model
	8,   // 95: model.model.v1alpha.UnpublishOrganizationModelResponse.model:type_name -> model.model.v1alpha.Model
	9,   // 96: model.model.v1alpha.GetOrganizationModelCardResponse.readme:type_name -> model.model.v1alpha.ModelCard
	0,   // 97: model.model.v1alpha.WatchOrganizationModelResponse.state:type_name -> model.model.v1alpha.State
	7,   // 98: model.model.v1alpha.ListOrganizationModelVersionsResponse.versions:type_name -> model.model.v1alpha.ModelVersion
	36,  // 99: model.model.v1alpha.TriggerOrganizationModelRequest.task_inputs:type_name -> model.model.v1alpha.TaskInput
	89,  // 100: model.model.v1alpha.TriggerOrganizationModelResponse.task:type_name -> common.task.v1alpha.Task
	38,  // 101: model.model.v1alpha.TriggerOrganizationModelResponse.task_outputs:type_name -> model.model.v1alpha.TaskOutput
	36,  // 102: model.model.v1alpha.TriggerAsyncOrganizationModelRequest.task_inputs:type_name -> model.model.v1alpha.TaskInput
	124, // 103: model.model.v1alpha.TriggerAsyncOrganizationModelResponse.operation:type_name -> google.longrunning.Operation
	37,  // 104: model.model.v1alpha.TriggerOrganizationModelBinaryFileUploadRequest.task_input:type_name -> model.model.v1alpha.TaskInputStream
	89,  // 105: model.model.v1alpha.TriggerOrganizationModelBinaryFileUploadResponse.task:type_name -> common.task.v1alpha.Task
	38,  // 106: model.model.v1alpha.TriggerOrganizationModelBinaryFileUploadResponse.task_outputs:type_name -> model.model.v1alpha.TaskOutput
	92,  // 107: model.model.v1alpha.GetModelOperationRequest.view:type_name -> model.model.v1alpha.View
	124, // 108: model.model.v1alpha.GetModelOperationResponse.operation:type_name -> google.longrunning.Operation
	6,   // 109: model.model.v1alpha.ListAvailableRegionsResponse.regions:type_name -> model.model.v1alpha.Region
	92,  // 110: model.model.v1alpha.ListModelsAdminRequest.view:type_name -> model.model.v1alpha.View
	8,   // 111: model.model.v1alpha.ListModelsAdminResponse.models:type_name -> model.model.v1alpha.Model
	92,  // 112: model.model.v1alpha.LookUpModelAdminRequest.view:type_name -> model.model.v1alpha.View
	8,   // 113: model.model.v1alpha.LookUpModelAdminResponse.model:type_name -> model.model.v1alpha.Model
