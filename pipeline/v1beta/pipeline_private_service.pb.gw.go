...
func RegisterPipelinePrivateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelinePrivateServiceServer) error {
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_ListPipelinesAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/ListPipelinesAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/ListPipelinesAdmin"))
		if err != nil {
	...
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_LookUpPipelineAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_ListPipelineReleasesAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/ListPipelineReleasesAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/ListPipelineReleasesAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_LookUpConnectionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterPipelinePrivateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelinePrivateServiceClient) error {
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_ListPipelinesAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/ListPipelinesAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/ListPipelinesAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_LookUpPipelineAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_ListPipelineReleasesAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/ListPipelineReleasesAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/ListPipelineReleasesAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_PipelinePrivateService_LookUpConnectionAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin", runtime.WithHTTPPathPattern("/pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PipelinePrivateService_ListPipelinesAdmin_0        = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"pipeline.v1beta.PipelinePrivateService", "ListPipelinesAdmin"}, ""))
	pattern_PipelinePrivateService_LookUpPipelineAdmin_0       = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"pipeline.v1beta.PipelinePrivateService", "LookUpPipelineAdmin"}, ""))
	pattern_PipelinePrivateService_ListPipelineReleasesAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"pipeline.v1beta.PipelinePrivateService", "ListPipelineReleasesAdmin"}, ""))
	pattern_PipelinePrivateService_LookUpConnectionAdmin_0     = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"pipeline.v1beta.PipelinePrivateService", "LookUpConnectionAdmin"}, ""))
)
