...
const file_pipeline_pipeline_v1beta_component_definition_proto_rawDesc = "" +
	"\n" +
	...
	"\x04icon\x18\x06 \x01(\tB\x03\xe0A\x03R\x04icon\x12K\n" +
	"\x04spec\x18\a \x01(\v22.pipeline.pipeline.v1beta.ComponentDefinition.SpecB\x03\xe0A\x03R\x04spec\x12@\n" +
	"\x04type\x18\b \x01(\x0e2'.pipeline.pipeline.v1beta.ComponentTypeB\x03\xe0A\x03R\x04type\x12!\n" +
	...
	"\aversion\x18\x0f \x01(\tB\x03\xe0A\x03R\aversion\x12B\n" +
	"\x05tasks\x18\x10 \x03(\v2'.pipeline.pipeline.v1beta.ComponentTaskB\x03\xe0A\x03R\x05tasks\x12%\n" +
	"\vdescription\x18\x11 \x01(\tB\x03\xe0A\x03R\vdescription\x12d\n" +
	"\rrelease_stage\x18\x12 \x01(\x0e2:.pipeline.pipeline.v1beta.ComponentDefinition.ReleaseStageB\x03\xe0A\x03R\freleaseStage\x12E\n" +
	"\x06events\x18\x13 \x03(\v2(.pipeline.pipeline.v1beta.ComponentEventB\x03\xe0A\x03R\x06events\x1a\xd0\x04\n" +
	"\x04Spec\x12U\n" +
	"\x17component_specification\x18\x03 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x03R\x16componentSpecification\x12\x80\x01\n" +
	"\x13data_specifications\x18\x05 \x03(\v2J.pipeline.pipeline.v1beta.ComponentDefinition.Spec.DataSpecificationsEntryB\x03\xe0A\x03R\x12dataSpecifications\x12\x83\x01\n" +
	"\x14event_specifications\x18\x06 \x03(\v2K.pipeline.pipeline.v1beta.ComponentDefinition.Spec.EventSpecificationsEntryB\x03\xe0A\x03R\x13eventSpecifications\x1ar\n" +
	"\x17DataSpecificationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.pipeline.pipeline.v1beta.DataSpecificationR\x05value:\x028\x01\x1at\n" +
	"\x18EventSpecificationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12B\n" +
	"\x05value\x18\x02 \x01(\v2,.pipeline.pipeline.v1beta.EventSpecificationR\x05value:\x028\x01\";\n" +
	"\x04View\x12\x14\n" +
	...
	"\x10message_examples\x18\x05 \x03(\v2\x17.google.protobuf.StructB\x03\xe0A\x03R\x0fmessageExamples\"\x8b\x02\n" +
	"\x1fListComponentDefinitionsRequest\x12%\n" +
	"\tpage_size\x18\x01 \x01(\x05B\x03\xe0A\x01H\x00R\bpageSize\x88\x01\x01\x12P\n" +
	"\x04view\x18\x03 \x01(\x0e22.pipeline.pipeline.v1beta.ComponentDefinition.ViewB\x03\xe0A\x01H\x01R\x04view\x88\x01\x01\x12 \n" +
	...
	"\x05_viewB\t\n" +
	"\a_filterB\a\n" +
	"\x05_pageJ\x04\b\x02\x10\x03\"\xdc\x01\n" +
	" ListComponentDefinitionsResponse\x12b\n" +
	"\x15component_definitions\x18\x01 \x03(\v2-.pipeline.pipeline.v1beta.ComponentDefinitionR\x14componentDefinitions\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\x12\x1b\n" +
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize\x12\x12\n" +
	"\x04page\x18\x05 \x01(\x05R\x04pageJ\x04\b\x02\x10\x03B\x85\x02\n" +
	"\x1ccom.pipeline.pipeline.v1betaB\x18ComponentDefinitionProtoP\x01ZIgithub.com/instill-ai/protogen-go/pipeline/pipeline/v1beta;pipelinev1beta\xa2\x02\x03PPX\xaa\x02\x18Pipeline.Pipeline.V1beta\xca\x02\x18Pipeline\\Pipeline\\V1beta\xe2\x02$Pipeline\\Pipeline\\V1beta\\GPBMetadata\xea\x02\x1aPipeline::Pipeline::V1betab\x06proto3"

var (
	file_pipeline_pipeline_v1beta_component_definition_proto_rawDescOnce sync.Once
	file_pipeline_pipeline_v1beta_component_definition_proto_rawDescData []byte
)
...
func file_pipeline_pipeline_v1beta_component_definition_proto_rawDescGZIP() []byte {
	file_pipeline_pipeline_v1beta_component_definition_proto_rawDescOnce.Do(func() {
		file_pipeline_pipeline_v1beta_component_definition_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pipeline_pipeline_v1beta_component_definition_proto_rawDesc), len(file_pipeline_pipeline_v1beta_component_definition_proto_rawDesc)))
	})
...
var file_pipeline_pipeline_v1beta_component_definition_proto_goTypes = []any{
...
func file_pipeline_pipeline_v1beta_component_definition_proto_init() {
	...
	file_pipeline_pipeline_v1beta_component_definition_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pipeline_pipeline_v1beta_component_definition_proto_rawDesc), len(file_pipeline_pipeline_v1beta_component_definition_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
