...
const (
	PipelinePrivateService_ListPipelinesAdmin_FullMethodName        = "/pipeline.pipeline.v1beta.PipelinePrivateService/ListPipelinesAdmin"
	PipelinePrivateService_LookUpPipelineAdmin_FullMethodName       = "/pipeline.pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin"
	PipelinePrivateService_ListPipelineReleasesAdmin_FullMethodName = "/pipeline.pipeline.v1beta.PipelinePrivateService/ListPipelineReleasesAdmin"
	PipelinePrivateService_LookUpConnectionAdmin_FullMethodName     = "/pipeline.pipeline.v1beta.PipelinePrivateService/LookUpConnectionAdmin"
)
...
var PipelinePrivateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pipeline.pipeline.v1beta.PipelinePrivateService",
	...
	Metadata: "pipeline/pipeline/v1beta/pipeline_private_service.proto",
}
