...
var filter_ArtifactPublicService_UpdateKnowledgeBase_0 = &utilities.DoubleArray{Encoding: map[string]int{"knowledge_base": 0, "namespace_id": 1, "knowledge_base_id": 2}, Base: []int{1, 1, 2, 3, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 3, 4}}
