...
func (AdvancedAuth_AuthFlowType) Descriptor() protoreflect.EnumDescriptor {
	return file_connector_v1alpha_auth_proto_enumTypes[0].Descriptor()
}

func (AdvancedAuth_AuthFlowType) Type() protoreflect.EnumType {
	return &file_connector_v1alpha_auth_proto_enumTypes[0]
}
...
func (AdvancedAuth_AuthFlowType) EnumDescriptor() ([]byte, []int) {
	return file_connector_v1alpha_auth_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *OauthConfigSpecification) Reset() {
	*x = OauthConfigSpecification{}
	if protoimpl.UnsafeEnabled {
		mi := &file_connector_v1alpha_auth_proto_msgTypes[0]
...
func (*OauthConfigSpecification) Descriptor() ([]byte, []int) {
	return file_connector_v1alpha_auth_proto_rawDescGZIP(), []int{0}
}
...
type AdvancedAuth struct {
	...
	AuthFlowType AdvancedAuth_AuthFlowType `protobuf:"varint,1,opt,name=auth_flow_type,json=authFlowType,proto3,enum=connector.v1alpha.AdvancedAuth_AuthFlowType" json:"auth_flow_type,omitempty"`
...
func (x *AdvancedAuth) Reset() {
	*x = AdvancedAuth{}
	if protoimpl.UnsafeEnabled {
		mi := &file_connector_v1alpha_auth_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdvancedAuth) Descriptor() ([]byte, []int) {
	return file_connector_v1alpha_auth_proto_rawDescGZIP(), []int{1}
}
...
var File_connector_v1alpha_auth_proto protoreflect.FileDescriptor

var file_connector_v1alpha_auth_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2f, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11,
	...
	,
	...
	0x02, 0x42, 0xcd, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x42, 0x09, 0x41, 0x75, 0x74,
	0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var (
	file_connector_v1alpha_auth_proto_rawDescOnce sync.Once
	file_connector_v1alpha_auth_proto_rawDescData = file_connector_v1alpha_auth_proto_rawDesc
)

func file_connector_v1alpha_auth_proto_rawDescGZIP() []byte {
	file_connector_v1alpha_auth_proto_rawDescOnce.Do(func() {
		file_connector_v1alpha_auth_proto_rawDescData = protoimpl.X.CompressGZIP(file_connector_v1alpha_auth_proto_rawDescData)
	})
	return file_connector_v1alpha_auth_proto_rawDescData
}

var file_connector_v1alpha_auth_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_connector_v1alpha_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_connector_v1alpha_auth_proto_goTypes = []interface{}{
	(AdvancedAuth_AuthFlowType)(0),   // 0: connector.v1alpha.AdvancedAuth.AuthFlowType
	(*OauthConfigSpecification)(nil), // 1: connector.v1alpha.OauthConfigSpecification
	(*AdvancedAuth)(nil),             // 2: connector.v1alpha.AdvancedAuth
	(*structpb.Struct)(nil),          // 3: google.protobuf.Struct
}
var file_connector_v1alpha_auth_proto_depIdxs = []int32{
	3, // 0: connector.v1alpha.OauthConfigSpecification.oauth_user_input_from_connector_config_specification:type_name -> google.protobuf.Struct
	3, // 1: connector.v1alpha.OauthConfigSpecification.complete_oauth_output_specification:type_name -> google.protobuf.Struct
	3, // 2: connector.v1alpha.OauthConfigSpecification.complete_oauth_server_input_specification:type_name -> google.protobuf.Struct
	3, // 3: connector.v1alpha.OauthConfigSpecification.complete_oauth_server_output_specification:type_name -> google.protobuf.Struct
	0, // 4: connector.v1alpha.AdvancedAuth.auth_flow_type:type_name -> connector.v1alpha.AdvancedAuth.AuthFlowType
	1, // 5: connector.v1alpha.AdvancedAuth.oauth_config_specification:type_name -> connector.v1alpha.OauthConfigSpecification
...
func init() { file_connector_v1alpha_auth_proto_init() }
func file_connector_v1alpha_auth_proto_init() {
	if File_connector_v1alpha_auth_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_connector_v1alpha_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_connector_v1alpha_auth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_connector_v1alpha_auth_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_connector_v1alpha_auth_proto_goTypes,
		DependencyIndexes: file_connector_v1alpha_auth_proto_depIdxs,
		EnumInfos:         file_connector_v1alpha_auth_proto_enumTypes,
		MessageInfos:      file_connector_v1alpha_auth_proto_msgTypes,
	}.Build()
	File_connector_v1alpha_auth_proto = out.File
	file_connector_v1alpha_auth_proto_rawDesc = nil
	file_connector_v1alpha_auth_proto_goTypes = nil
	file_connector_v1alpha_auth_proto_depIdxs = nil
}
